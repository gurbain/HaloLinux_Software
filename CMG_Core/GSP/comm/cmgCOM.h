 ...
 * Jose Gomez, Isaac Garza (version 1)
...
#define All_CMG				0xFF // actID used to command all four CMGs at the same time
...
static void * telem_thread_helper(void * This)

	{

		((cmgGSP *)This)->queryCMGstate();
...
void write_data(float * telem_array, bool accept_bit);
...
void cmgWrite(unsigned char *msg_write);

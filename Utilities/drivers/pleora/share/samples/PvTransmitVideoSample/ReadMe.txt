...
This sample code illustrates how to use the PvVirtualDevice and PvTransmitterRaw classes in conjunction with FFmpeg to transmit a video file using the eBUS SDK.
...
Using FFmpeg, an image is continuously captured from a video file.
 ...
 * You have installed version 0.11.X of FFmpeg to the default location and that the FFmpeg binaries are in the runtime path. ( see the samples/ReadMe.txt for more details )

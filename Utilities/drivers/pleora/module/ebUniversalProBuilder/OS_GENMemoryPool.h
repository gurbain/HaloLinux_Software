...
OS_EXTERN OS_RESULT OS_MemoryPoolCreate( OS_DRV_CONTEXT* aContext, OS_MEMORYPOOL* aMemPool, OS_UINT32 aNumElement, OS_SIZE aElementSize );
OS_EXTERN OS_VOID OS_MemoryPoolDestroy( OS_MEMORYPOOL* aMemPool );

...
OS_EXTERN OS_RESULT OS_ShareMemoryStaticInit( OS_VOID );
OS_EXTERN OS_RESULT OS_ShareMemoryStaticClose(OS_VOID );
OS_EXTERN OS_RESULT OS_ShareMemoryInit( OS_DRV_CONTEXT* aContext, OS_SHAREMEMORY* aShareMemory, 
                                        OS_CHAR* aName, OS_UINT32 aNameSize, OS_SIZE aSize, OS_UINT8** aPtr,
                                        OS_SHAREDMEMORYINITCALLBACK aCallback );
OS_EXTERN OS_RESULT OS_ShareMemoryFree( OS_SHAREMEMORY* aShareMemory );

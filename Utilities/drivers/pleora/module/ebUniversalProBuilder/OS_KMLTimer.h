...
OS_EXTERN OS_RESULT OS_TimerCheck( OS_VOID );
OS_EXTERN OS_RESULT OS_TimerCreate( OS_DRV_CONTEXT* aContext, OS_TIMER* aTimer, OS_UINT32 aPeriodic, 
    OS_TIMER_FNC aFunction, OS_VOID* aData, OS_UINT32 aPeriod /* ms */ );
OS_EXTERN OS_RESULT OS_TimerDestroy( OS_TIMER* aTimer ); 

...
OS_EXTERN OS_RESULT OS_WorkQueueCheck( OS_VOID );
OS_EXTERN OS_RESULT OS_WorkQueueInit( OS_WORKQUEUE* aWorkQueue, OS_CHAR* aName, 
	POS_WORKQUEUE_FUNC aFunction );
OS_EXTERN OS_RESULT OS_WorkQueueFree( OS_WORKQUEUE* aWorkQueue );
OS_EXTERN OS_RESULT OS_WorkQueueSchedule( OS_WORKQUEUE* aWorkQueue, 

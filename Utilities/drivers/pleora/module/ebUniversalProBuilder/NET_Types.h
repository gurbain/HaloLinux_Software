...
#define NET_ETH_TYPE_IPV4               0x0008
#define NET_ETH_TYPE_IPV6               0xdd86

#define NET_IP_ADDRESS_FAMILY_LEN       1
#define NET_IP_ADDRESS_FAMILY(buffer)   ((*(PUCHAR)(buffer)) >> 4)

#define NET_IP_ADDRESS_FAMILY_IP4       4
#define NET_IP_ADDRESS_FAMILY_IP6       6

#define NET_IP_DONTFRAGMENTFLAG         0x40
...
{
    OS_UINT32 Version : 4;
    OS_UINT32 TrafficClass : 8;
    OS_UINT32 FlowLabel : 20; 

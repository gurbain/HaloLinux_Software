...
void init()
{
        ...
        cout<<"\n=============== FLIR A5 Acquisition Software ===============\n"<<endl;
	cout<<"This software allows the user to take and save images"<<endl;
	cout<<"given by a FLIR A5 thermocamera connected by ethernet with"<<endl;
	cout<<"a static IP using pleora ebus SDK"<<endl<<endl;
	cout<<"PID of the process: "<<(int)getpid()<<endl;
	cout<<"Compiled  On: \t"<<__DATE__<<" at "<<__TIME__<<" UTC"<<endl;
	cout<<"          With:\tGCC: "<< __VERSION__<<endl;
	struct utsname ver;
	uname(&ver);
	cout<<"\t\tUbuntu: 10.04 - kernel "<<ver.release<<endl;
	cout<<"\t\tOpenCV: "<<CV_VERSION<<endl;
	cout<<"Author: "<<__AUTHOR__<<endl;
	cout<<"Space Systems Lab (SSL) - INSPECT project"<<endl;
	cout<<"August 2014 - Massachussets Institute of Technology (MIT)\n"<<endl;
	cout<<"=============================================================\n"<<endl;
